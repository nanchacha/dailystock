            ...
            days.push(
                ...
                >
                    ...
                    {themes && themes.length > 0 && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center pt-4 pointer-events-none gap-0.5">
                            {/* Main Theme */}
                            ...
                            {themes.length > 1 && (
                                <span className="text-sm filter drop-shadow-sm opacity-90 z-0">
                                    {themes[1]}
                                </span>
                            )}
                        </div>
    ...
    return (
        <div className="bg-white rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-slate-100 overflow-hidden p-6">
            ...
            <div className="mb-6 flex flex-wrap gap-2 p-3 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <span className="text-[10px] text-slate-500 font-medium flex items-center gap-1"><span className="text-base">🏛️</span>정책</span>
                ...
                <span className="text-[10px] text-slate-500 font-medium flex items-center gap-1"><span className="text-base">🌀</span>신재생</span>
            </div>
